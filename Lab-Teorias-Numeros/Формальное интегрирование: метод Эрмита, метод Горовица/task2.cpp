...
// Функция для формального интегрирования дробнорациональной функции методом Горовица
Polynomial gorovitzIntegration(const Polynomial& numerator, const Polynomial& denominator) {
...
int main() {
    ...
    Polynomial result = gorovitzIntegration(numerator, denominator);
